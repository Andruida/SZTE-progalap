...
int elorejelez(int feljegyzesek[]) {
    ...
    for (mintahossz = 12; feljegyzesek[mintahossz-1] != -1; mintahossz++) {
        int vege = 0;
        int offset = 1;
        int helyes = 1;
        while (!vege && helyes) {
            for (int x = 0; x < mintahossz; x++) {
                int i = x+(mintahossz*offset);
                if (feljegyzesek[i] == -1) {
                    hossz = i;
                    vege = 1;
                    break;
                }
                int fi = feljegyzesek[i];
                int fx = feljegyzesek[x];
                if (feljegyzesek[i] != feljegyzesek[x]) {
                    helyes = 0;
                    break;
                }
            }
    ...
    // return mintahossz;
    return feljegyzesek[hossz % mintahossz];
}
/***********************************************************************
************************************************************************
**
